...
--
-- Table structure for table `dbo_errorlog`
--

DROP TABLE IF EXISTS `dbo_errorlog`;
...
--
-- Dumping data for table `dbo_errorlog`
--

LOCK TABLES `dbo_errorlog` WRITE;
/*!40000 ALTER TABLE `dbo_errorlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `dbo_errorlog` ENABLE KEYS */;
UNLOCK TABLES;
